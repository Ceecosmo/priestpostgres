"""
Django settings for priestsite project.
...
WSGI_APPLICATION = 'priestsite.wsgi.application'
...
STATICFILES_DIR = [
    ...
    os.path.join(BASE_DIR, 'logistic/staticfiles')

 ]

STATIC_ROOT = os.path.join(BASE_DIR, 'logistic/staticfiles')
...
CORS_ORIGIN_WHITELIST = ['https://priestwelfare.netlify.app',
